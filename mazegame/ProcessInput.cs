...
static class ProcessInput
{
    ...
    private static Dictionary<Keys, Action<GameState>> keyActions = new Dictionary<Keys, Action<GameState>>()
    {
        ...
        { Keys.I, (gameState) => gameState.MovePlayer(0, -1) },
        { Keys.J, (gameState) => gameState.MovePlayer(-1, 0) },
        { Keys.K, (gameState) => gameState.MovePlayer(0, 1) },
        { Keys.L, (gameState) => gameState.MovePlayer(1, 0) },
